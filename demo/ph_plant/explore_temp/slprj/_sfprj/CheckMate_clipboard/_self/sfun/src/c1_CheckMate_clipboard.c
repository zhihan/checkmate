...
/* Named Constants */
#define c1_event_start                 (0)
#define c1_event_High_pH               (1)
#define c1_event_Low_pH                (2)
#define c1_event_full                  (3)
#define c1_event_pH_not_High           (4)
#define c1_event_pH_not_Low            (5)
#define CALL_EVENT                     (-1)
#define c1_IN_NO_ACTIVE_CHILD          ((uint8_T)0U)
#define c1_IN_acid                     ((uint8_T)1U)
#define c1_IN_alkaline                 ((uint8_T)2U)
#define c1_IN_avoid                    ((uint8_T)3U)
#define c1_IN_normal                   ((uint8_T)4U)
#define c1_IN_reach                    ((uint8_T)5U)
...
static real_T c1_emlrt_marshallIn(SFc1_CheckMate_clipboardInstanceStruct
  *chartInstance, const mxArray *c1_start, const char_T *c1_identifier);
...
static uint8_T c1_d_emlrt_marshallIn(SFc1_CheckMate_clipboardInstanceStruct
  *chartInstance, const mxArray *c1_b_tp_reach, const char_T *c1_identifier);
  ...
  (SFc1_CheckMate_clipboardInstanceStruct *chartInstance)
{
  ...
  chartInstance->c1_tp_acid = 0U;
  chartInstance->c1_tp_alkaline = 0U;
  chartInstance->c1_tp_avoid = 0U;
  chartInstance->c1_tp_normal = 0U;
  chartInstance->c1_tp_reach = 0U;
  ...
  (SFc1_CheckMate_clipboardInstanceStruct *chartInstance)
{
  ...
  if (chartInstance->c1_is_c1_CheckMate_clipboard == c1_IN_alkaline) {
    _SFD_CS_CALL(STATE_ACTIVE_TAG, 1U, chartInstance->c1_sfEvent);
  } else {
    _SFD_CS_CALL(STATE_INACTIVE_TAG, 1U, chartInstance->c1_sfEvent);
  }

  if (chartInstance->c1_is_c1_CheckMate_clipboard == c1_IN_acid) {
  ...
  (SFc1_CheckMate_clipboardInstanceStruct *chartInstance)
{
  if (chartInstance->c1_doSetSimStateSideEffects != 0) {
    if (chartInstance->c1_is_c1_CheckMate_clipboard == c1_IN_acid) {
      chartInstance->c1_tp_acid = 1U;
    } else {
      chartInstance->c1_tp_acid = 0U;
    }

    if (chartInstance->c1_is_c1_CheckMate_clipboard == c1_IN_alkaline) {
      chartInstance->c1_tp_alkaline = 1U;
    } else {
      chartInstance->c1_tp_alkaline = 0U;
    }
  ...
  *chartInstance)
{
  ...
  real_T *c1_Low_pH;
  real_T *c1_full;
  real_T *c1_pH_not_High;
  real_T *c1_pH_not_Low;
  c1_pH_not_Low = (real_T *)*(ssGetInputPortSignalPtrs(chartInstance->S, 0) + 5);
  c1_pH_not_High = (real_T *)*(ssGetInputPortSignalPtrs(chartInstance->S, 0) + 4);
  c1_full = (real_T *)*(ssGetInputPortSignalPtrs(chartInstance->S, 0) + 3);
  c1_Low_pH = (real_T *)*(ssGetInputPortSignalPtrs(chartInstance->S, 0) + 2);
  c1_High_pH = (real_T *)*(ssGetInputPortSignalPtrs(chartInstance->S, 0) + 1);
  c1_start = (real_T *)*(ssGetInputPortSignalPtrs(chartInstance->S, 0) + 0);
  c1_q = (real_T *)ssGetOutputPortSignal(chartInstance->S, 1);
  ...
  if (*c1_High_pH == 1.0) {
    chartInstance->c1_sfEvent = c1_event_High_pH;
    _SFD_CE_CALL(EVENT_BEFORE_BROADCAST_TAG, c1_event_High_pH,
                 chartInstance->c1_sfEvent);
    c1_chartstep_c1_CheckMate_clipboard(chartInstance);
    _SFD_CE_CALL(EVENT_AFTER_BROADCAST_TAG, c1_event_High_pH,
                 chartInstance->c1_sfEvent);
  }

  if (*c1_Low_pH == 1.0) {
    chartInstance->c1_sfEvent = c1_event_Low_pH;
    _SFD_CE_CALL(EVENT_BEFORE_BROADCAST_TAG, c1_event_Low_pH,
                 chartInstance->c1_sfEvent);
    c1_chartstep_c1_CheckMate_clipboard(chartInstance);
    _SFD_CE_CALL(EVENT_AFTER_BROADCAST_TAG, c1_event_Low_pH,
                 chartInstance->c1_sfEvent);
  }

  if (*c1_full == 1.0) {
    chartInstance->c1_sfEvent = c1_event_full;
    _SFD_CE_CALL(EVENT_BEFORE_BROADCAST_TAG, c1_event_full,
                 chartInstance->c1_sfEvent);
    c1_chartstep_c1_CheckMate_clipboard(chartInstance);
    _SFD_CE_CALL(EVENT_AFTER_BROADCAST_TAG, c1_event_full,
                 chartInstance->c1_sfEvent);
  }

  if (*c1_pH_not_High == 1.0) {
    chartInstance->c1_sfEvent = c1_event_pH_not_High;
    _SFD_CE_CALL(EVENT_BEFORE_BROADCAST_TAG, c1_event_pH_not_High,
                 chartInstance->c1_sfEvent);
    c1_chartstep_c1_CheckMate_clipboard(chartInstance);
    _SFD_CE_CALL(EVENT_AFTER_BROADCAST_TAG, c1_event_pH_not_High,
                 chartInstance->c1_sfEvent);
  }

  if (*c1_pH_not_Low == 1.0) {
    chartInstance->c1_sfEvent = c1_event_pH_not_Low;
    _SFD_CE_CALL(EVENT_BEFORE_BROADCAST_TAG, c1_event_pH_not_Low,
                 chartInstance->c1_sfEvent);
    c1_chartstep_c1_CheckMate_clipboard(chartInstance);
    _SFD_CE_CALL(EVENT_AFTER_BROADCAST_TAG, c1_event_pH_not_Low,
                 chartInstance->c1_sfEvent);
  }
  ...
  (SFc1_CheckMate_clipboardInstanceStruct *chartInstance)
{
  ...
  if (chartInstance->c1_is_active_c1_CheckMate_clipboard == 0U) {
    ...
    if (c1_out) {
      ...
      chartInstance->c1_is_c1_CheckMate_clipboard = c1_IN_normal;
      _SFD_CS_CALL(STATE_ACTIVE_TAG, 3U, chartInstance->c1_sfEvent);
      chartInstance->c1_tp_normal = 1U;
      *c1_q = 1.0;
      _SFD_DATA_RANGE_CHECK(*c1_q, 0U);
    ...
    switch (chartInstance->c1_is_c1_CheckMate_clipboard) {
     case c1_IN_acid:
      ...
      c1_b_out = (CV_TRANSITION_EVAL(4U, (int32_T)_SFD_CCP_CALL(4U, 0,
        chartInstance->c1_sfEvent == c1_event_pH_not_Low != 0U,
        chartInstance->c1_sfEvent)) != 0);
      if (c1_b_out) {
        if (_SFD_TRANSITION_CONFLICT_CHECK_ENABLED()) {
          ...
          c1_c_out = (chartInstance->c1_sfEvent == c1_event_full);
          if (c1_c_out) {
        ...
        *c1_q = 1.0;
        ...
        c1_d_out = (CV_TRANSITION_EVAL(5U, (int32_T)_SFD_CCP_CALL(5U, 0,
          chartInstance->c1_sfEvent == c1_event_full != 0U,
          chartInstance->c1_sfEvent)) != 0);
        if (c1_d_out) {
     ...
     case c1_IN_alkaline:
      ...
      _SFD_CT_CALL(TRANSITION_BEFORE_PROCESSING_TAG, 3U,
                   chartInstance->c1_sfEvent);
      c1_e_out = (CV_TRANSITION_EVAL(3U, (int32_T)_SFD_CCP_CALL(3U, 0,
        chartInstance->c1_sfEvent == c1_event_pH_not_High != 0U,
        chartInstance->c1_sfEvent)) != 0);
      if (c1_e_out) {
        if (_SFD_TRANSITION_CONFLICT_CHECK_ENABLED()) {
          unsigned int transitionList[2];
          ...
          transitionList[0] = 3;
          _SFD_TRANSITION_CONFLICT_CHECK_BEGIN();
          c1_f_out = (chartInstance->c1_sfEvent == c1_event_full);
          if (c1_f_out) {
        ...
        *c1_q = 1.0;
        ...
        _SFD_CT_CALL(TRANSITION_BEFORE_PROCESSING_TAG, 6U,
                     chartInstance->c1_sfEvent);
        c1_g_out = (CV_TRANSITION_EVAL(6U, (int32_T)_SFD_CCP_CALL(6U, 0,
          chartInstance->c1_sfEvent == c1_event_full != 0U,
          chartInstance->c1_sfEvent)) != 0);
        if (c1_g_out) {
     ...
     case c1_IN_normal:
      ...
      _SFD_CT_CALL(TRANSITION_BEFORE_PROCESSING_TAG, 7U,
                   chartInstance->c1_sfEvent);
      c1_h_out = (CV_TRANSITION_EVAL(7U, (int32_T)_SFD_CCP_CALL(7U, 0,
        chartInstance->c1_sfEvent == c1_event_full != 0U,
        chartInstance->c1_sfEvent)) != 0);
      if (c1_h_out) {
        if (_SFD_TRANSITION_CONFLICT_CHECK_ENABLED()) {
          ...
          transitionList[0] = 7;
          _SFD_TRANSITION_CONFLICT_CHECK_BEGIN();
          c1_i_out = (chartInstance->c1_sfEvent == c1_event_Low_pH);
          if (c1_i_out) {
            transitionList[numTransitions] = 2;
            numTransitions++;
          }

          c1_j_out = (chartInstance->c1_sfEvent == c1_event_High_pH);
          if (c1_j_out) {
        ...
        chartInstance->c1_tp_normal = 0U;
        _SFD_CS_CALL(STATE_INACTIVE_TAG, 3U, chartInstance->c1_sfEvent);
        chartInstance->c1_is_c1_CheckMate_clipboard = c1_IN_reach;
        _SFD_CS_CALL(STATE_ACTIVE_TAG, 4U, chartInstance->c1_sfEvent);
        chartInstance->c1_tp_reach = 1U;
        *c1_q = 5.0;
        _SFD_DATA_RANGE_CHECK(*c1_q, 0U);
        ...
        _SFD_CT_CALL(TRANSITION_BEFORE_PROCESSING_TAG, 2U,
                     chartInstance->c1_sfEvent);
        c1_k_out = (CV_TRANSITION_EVAL(2U, (int32_T)_SFD_CCP_CALL(2U, 0,
          chartInstance->c1_sfEvent == c1_event_Low_pH != 0U,
          chartInstance->c1_sfEvent)) != 0);
        if (c1_k_out) {
          if (_SFD_TRANSITION_CONFLICT_CHECK_ENABLED()) {
            unsigned int transitionList[2];
            ...
            transitionList[0] = 2;
            _SFD_TRANSITION_CONFLICT_CHECK_BEGIN();
            c1_l_out = (chartInstance->c1_sfEvent == c1_event_High_pH);
            if (c1_l_out) {
              transitionList[numTransitions] = 1;
              numTransitions++;
            }
          ...
          chartInstance->c1_tp_normal = 0U;
          _SFD_CS_CALL(STATE_INACTIVE_TAG, 3U, chartInstance->c1_sfEvent);
          chartInstance->c1_is_c1_CheckMate_clipboard = c1_IN_acid;
          _SFD_CS_CALL(STATE_ACTIVE_TAG, 0U, chartInstance->c1_sfEvent);
          chartInstance->c1_tp_acid = 1U;
          *c1_q = 3.0;
          _SFD_DATA_RANGE_CHECK(*c1_q, 0U);
          ...
          _SFD_CT_CALL(TRANSITION_BEFORE_PROCESSING_TAG, 1U,
                       chartInstance->c1_sfEvent);
          c1_m_out = (CV_TRANSITION_EVAL(1U, (int32_T)_SFD_CCP_CALL(1U, 0,
            chartInstance->c1_sfEvent == c1_event_High_pH != 0U,
            chartInstance->c1_sfEvent)) != 0);
          if (c1_m_out) {
            _SFD_CT_CALL(TRANSITION_ACTIVE_TAG, 1U, chartInstance->c1_sfEvent);
            chartInstance->c1_tp_normal = 0U;
            _SFD_CS_CALL(STATE_INACTIVE_TAG, 3U, chartInstance->c1_sfEvent);
            chartInstance->c1_is_c1_CheckMate_clipboard = c1_IN_alkaline;
            _SFD_CS_CALL(STATE_ACTIVE_TAG, 1U, chartInstance->c1_sfEvent);
            chartInstance->c1_tp_alkaline = 1U;
            *c1_q = 2.0;
            _SFD_DATA_RANGE_CHECK(*c1_q, 0U);
  ...
  *chartInstance, const mxArray *c1_start, const char_T *c1_identifier)
{
  ...
  c1_y = c1_b_emlrt_marshallIn(chartInstance, sf_mex_dup(c1_start), &c1_thisId);
...
static void c1_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c1_mxArrayInData, const char_T *c1_varName, void *c1_outData)
{
  const mxArray *c1_start;
  const char_T *c1_identifier;
  emlrtMsgIdentifier c1_thisId;
  real_T c1_y;
  SFc1_CheckMate_clipboardInstanceStruct *chartInstance;
  chartInstance = (SFc1_CheckMate_clipboardInstanceStruct *)chartInstanceVoid;
  c1_start = sf_mex_dup(c1_mxArrayInData);
  ...
  *chartInstance, const mxArray *c1_b_tp_reach, const char_T *c1_identifier)
{
  ...
  c1_thisId.fIdentifier = c1_identifier;
  c1_thisId.fParent = NULL;
  c1_y = c1_e_emlrt_marshallIn(chartInstance, sf_mex_dup(c1_b_tp_reach),
    &c1_thisId);
  sf_mex_destroy(&c1_b_tp_reach);
  return c1_y;
}
...
static void c1_c_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c1_mxArrayInData, const char_T *c1_varName, void *c1_outData)
{
  const mxArray *c1_b_tp_reach;
  const char_T *c1_identifier;
  emlrtMsgIdentifier c1_thisId;
  uint8_T c1_y;
  SFc1_CheckMate_clipboardInstanceStruct *chartInstance;
  chartInstance = (SFc1_CheckMate_clipboardInstanceStruct *)chartInstanceVoid;
  c1_b_tp_reach = sf_mex_dup(c1_mxArrayInData);
  c1_identifier = c1_varName;
  c1_thisId.fIdentifier = c1_identifier;
  c1_thisId.fParent = NULL;
  c1_y = c1_e_emlrt_marshallIn(chartInstance, sf_mex_dup(c1_b_tp_reach),
...
{
  ((real_T *)mxGetPr((plhs[0])))[0] = (real_T)(3731380110U);
  ((real_T *)mxGetPr((plhs[0])))[1] = (real_T)(2559400398U);
  ((real_T *)mxGetPr((plhs[0])))[2] = (real_T)(4270532854U);
  ((real_T *)mxGetPr((plhs[0])))[3] = (real_T)(3151028540U);
}
...
static const mxArray *sf_get_sim_state_info_c1_CheckMate_clipboard(void)
{
  ...
  const char *infoEncStr[] = {
    "100 S1x3'type','srcId','name','auxInfo'{{M[1],M[14],T\"q\",},{M[8],M[0],T\"is_active_c1_CheckMate_clipboard\",},{M[9],M[0],T\"is_c1_CheckMate_clipboard\",}}"
  };
...
static void mdlSetWorkWidths_c1_CheckMate_clipboard(SimStruct *S)
{
  ...
  ssSetChecksum0(S,(3874037689U));
  ssSetChecksum1(S,(3034914332U));
  ssSetChecksum2(S,(1528323479U));
  ssSetChecksum3(S,(3587874945U));
