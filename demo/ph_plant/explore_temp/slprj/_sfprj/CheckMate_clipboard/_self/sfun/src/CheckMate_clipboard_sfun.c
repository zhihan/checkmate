  ...
  plhs[], int nrhs, const mxArray * prhs[] )
{
  ...
  if (nrhs>1 && mxIsChar(prhs[1])) {
    ...
    ((real_T *)mxGetPr((plhs[0])))[0] = (real_T)(409102585U);
    ((real_T *)mxGetPr((plhs[0])))[1] = (real_T)(794336587U);
    ((real_T *)mxGetPr((plhs[0])))[2] = (real_T)(1027776833U);
    ((real_T *)mxGetPr((plhs[0])))[3] = (real_T)(2666903165U);
  }
  ...
  plhs[], int nrhs, const mxArray * prhs[] )
{
...

  {
    ...
    switch (chartFileNumber) {
     case 1:
      {
        if (strcmp(tpChksum, "HJ85JypzAg6mKtYKSAz3uH") == 0) {
