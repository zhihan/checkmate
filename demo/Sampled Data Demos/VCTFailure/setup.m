...
GLOBAL_SPEC={};
%GLOBAL_SPEC{1} = '(AG ((cntrl_mode == pid)|(AF cntrl_mode == pid)))';

%The next line is a proposed improvement over the specification in the previous line.
%This one should cover the case where the system simply stays within the PID mode.
GLOBAL_SPEC{1} = 'AF((~cntrl_mode == pid) & AF (cntrl_mode == pid))';
