  ...
  unsigned int chartFileNumber, const char* specsCksum, int_T method, void *data)
{
  ...
  if (chartFileNumber==2) {
    c2_CheckMate_clipboard_method_dispatcher(simstructPtr, method, data);
    return 1;
  }

  if (chartFileNumber==3) {
    c3_CheckMate_clipboard_method_dispatcher(simstructPtr, method, data);
    return 1;
  }
  ...
  plhs[], int nrhs, const mxArray * prhs[] )
{
  ...
  if (nrhs>1 && mxIsChar(prhs[1])) {
    ...
    if (!strcmp(commandName,"machine")) {
      ...
      ((real_T *)mxGetPr((plhs[0])))[0] = (real_T)(2346931216U);
      ((real_T *)mxGetPr((plhs[0])))[1] = (real_T)(3548805916U);
      ((real_T *)mxGetPr((plhs[0])))[2] = (real_T)(2212676864U);
      ((real_T *)mxGetPr((plhs[0])))[3] = (real_T)(4125449338U);
      ...
      switch (chartFileNumber) {
       ...
       case 2:
        {
          extern void sf_c2_CheckMate_clipboard_get_check_sum(mxArray *plhs[]);
          sf_c2_CheckMate_clipboard_get_check_sum(plhs);
          break;
        }
       ...
       case 3:
        {
          ...
          sf_c3_CheckMate_clipboard_get_check_sum(plhs);
          break;
        }
    ...
    ((real_T *)mxGetPr((plhs[0])))[0] = (real_T)(4249885185U);
    ((real_T *)mxGetPr((plhs[0])))[1] = (real_T)(2885562751U);
    ((real_T *)mxGetPr((plhs[0])))[2] = (real_T)(2611844740U);
    ((real_T *)mxGetPr((plhs[0])))[3] = (real_T)(4251115637U);
  }
...

  {
    ...
    switch (chartFileNumber) {
     ...
     case 2:
      {
        if (strcmp(aiChksum, "goUbELse0fT4WPqIM166oH") == 0) {
          extern mxArray *sf_c2_CheckMate_clipboard_get_autoinheritance_info
            (void);
          plhs[0] = sf_c2_CheckMate_clipboard_get_autoinheritance_info();
          break;
        }
     ...
     case 3:
      {
        if (strcmp(aiChksum, "goUbELse0fT4WPqIM166oH") == 0) {
          extern mxArray *sf_c3_CheckMate_clipboard_get_autoinheritance_info
            (void);
          plhs[0] = sf_c3_CheckMate_clipboard_get_autoinheritance_info();
          break;
        }
...

  {
    ...
    switch (chartFileNumber) {
     ...
     case 2:
      {
        extern const mxArray
          *sf_c2_CheckMate_clipboard_get_eml_resolved_functions_info(void);
        mxArray *persistentMxArray = (mxArray *)
          sf_c2_CheckMate_clipboard_get_eml_resolved_functions_info();
        plhs[0] = mxDuplicateArray(persistentMxArray);
        mxDestroyArray(persistentMxArray);
        break;
      }
     ...
     case 3:
      {
        extern const mxArray
          *sf_c3_CheckMate_clipboard_get_eml_resolved_functions_info(void);
        mxArray *persistentMxArray = (mxArray *)
          sf_c3_CheckMate_clipboard_get_eml_resolved_functions_info();
        plhs[0] = mxDuplicateArray(persistentMxArray);
        mxDestroyArray(persistentMxArray);
        break;
      }
  ...
  plhs[], int nrhs, const mxArray * prhs[] )
{
...

  {
    ...
    switch (chartFileNumber) {
     case 1:
      {
        if (strcmp(tpChksum, "RCLlLUvovZKqttDBr3n0ZB") == 0) {
     ...
     case 2:
      {
        if (strcmp(tpChksum, "KAkjZBit4HJM7fXBfoAq1D") == 0) {
          extern mxArray *sf_c2_CheckMate_clipboard_third_party_uses_info(void);
          plhs[0] = sf_c2_CheckMate_clipboard_third_party_uses_info();
          break;
        }
      }
     ...
     case 3:
      {
        if (strcmp(tpChksum, "qCEwc8Mp41krSAwTYIqcDF") == 0) {
          extern mxArray *sf_c3_CheckMate_clipboard_third_party_uses_info(void);
          plhs[0] = sf_c3_CheckMate_clipboard_third_party_uses_info();
          break;
        }
      }
  ...
  debugInstance)
{
  _CheckMate_clipboardMachineNumber_ = sf_debug_initialize_machine(debugInstance,
    "CheckMate_clipboard","sfun",0,3,0,0,0);
