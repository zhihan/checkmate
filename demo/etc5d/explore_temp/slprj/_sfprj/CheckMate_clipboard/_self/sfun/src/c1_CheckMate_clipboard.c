...
#define c1_event_above                 (1)
#define c1_event_negabove              (2)
#define c1_event_below                 (3)
#define c1_event_negbelow              (4)
#define CALL_EVENT                     (-1)
#define c1_IN_NO_ACTIVE_CHILD          ((uint8_T)0U)
#define c1_IN_beyond                   ((uint8_T)1U)
#define c1_IN_on                       ((uint8_T)2U)
#define c1_IN_under                    ((uint8_T)3U)
...
static uint8_T c1_d_emlrt_marshallIn(SFc1_CheckMate_clipboardInstanceStruct
  *chartInstance, const mxArray *c1_b_tp_on, const char_T *c1_identifier);
  ...
  (SFc1_CheckMate_clipboardInstanceStruct *chartInstance)
{
  ...
  chartInstance->c1_tp_beyond = 0U;
  chartInstance->c1_tp_on = 0U;
  chartInstance->c1_tp_under = 0U;
  ...
  (SFc1_CheckMate_clipboardInstanceStruct *chartInstance)
{
  ...
  if (chartInstance->c1_is_c1_CheckMate_clipboard == c1_IN_on) {
    _SFD_CS_CALL(STATE_ACTIVE_TAG, 1U, chartInstance->c1_sfEvent);
  } else {
    _SFD_CS_CALL(STATE_INACTIVE_TAG, 1U, chartInstance->c1_sfEvent);
  }

  if (chartInstance->c1_is_c1_CheckMate_clipboard == c1_IN_under) {
    _SFD_CS_CALL(STATE_ACTIVE_TAG, 2U, chartInstance->c1_sfEvent);
  } else {
    _SFD_CS_CALL(STATE_INACTIVE_TAG, 2U, chartInstance->c1_sfEvent);
  }

  if (chartInstance->c1_is_c1_CheckMate_clipboard == c1_IN_beyond) {
  ...
  *chartInstance)
{
  ...
  real_T *c1_below;
  real_T *c1_negbelow;
  c1_negbelow = (real_T *)*(ssGetInputPortSignalPtrs(chartInstance->S, 0) + 4);
  c1_below = (real_T *)*(ssGetInputPortSignalPtrs(chartInstance->S, 0) + 3);
  c1_negabove = (real_T *)*(ssGetInputPortSignalPtrs(chartInstance->S, 0) + 2);
  c1_above = (real_T *)*(ssGetInputPortSignalPtrs(chartInstance->S, 0) + 1);
  ...
  if (*c1_above == 1.0) {
    chartInstance->c1_sfEvent = c1_event_above;
    _SFD_CE_CALL(EVENT_BEFORE_BROADCAST_TAG, c1_event_above,
                 chartInstance->c1_sfEvent);
    c1_chartstep_c1_CheckMate_clipboard(chartInstance);
    _SFD_CE_CALL(EVENT_AFTER_BROADCAST_TAG, c1_event_above,
                 chartInstance->c1_sfEvent);
  }

  if (*c1_negabove == 1.0) {
    chartInstance->c1_sfEvent = c1_event_negabove;
    _SFD_CE_CALL(EVENT_BEFORE_BROADCAST_TAG, c1_event_negabove,
                 chartInstance->c1_sfEvent);
    c1_chartstep_c1_CheckMate_clipboard(chartInstance);
    _SFD_CE_CALL(EVENT_AFTER_BROADCAST_TAG, c1_event_negabove,
                 chartInstance->c1_sfEvent);
  }

  if (*c1_below == 1.0) {
    chartInstance->c1_sfEvent = c1_event_below;
    _SFD_CE_CALL(EVENT_BEFORE_BROADCAST_TAG, c1_event_below,
                 chartInstance->c1_sfEvent);
    c1_chartstep_c1_CheckMate_clipboard(chartInstance);
    _SFD_CE_CALL(EVENT_AFTER_BROADCAST_TAG, c1_event_below,
                 chartInstance->c1_sfEvent);
  }

  if (*c1_negbelow == 1.0) {
    chartInstance->c1_sfEvent = c1_event_negbelow;
    _SFD_CE_CALL(EVENT_BEFORE_BROADCAST_TAG, c1_event_negbelow,
                 chartInstance->c1_sfEvent);
    c1_chartstep_c1_CheckMate_clipboard(chartInstance);
    _SFD_CE_CALL(EVENT_AFTER_BROADCAST_TAG, c1_event_negbelow,
                 chartInstance->c1_sfEvent);
  }
  ...
  (SFc1_CheckMate_clipboardInstanceStruct *chartInstance)
{
  ...
  if (chartInstance->c1_is_active_c1_CheckMate_clipboard == 0U) {
    ...
    if (c1_out) {
      ...
      chartInstance->c1_is_c1_CheckMate_clipboard = c1_IN_beyond;
      _SFD_CS_CALL(STATE_ACTIVE_TAG, 0U, chartInstance->c1_sfEvent);
      chartInstance->c1_tp_beyond = 1U;
      *c1_q = 3.0;
      _SFD_DATA_RANGE_CHECK(*c1_q, 0U);
    ...
    switch (chartInstance->c1_is_c1_CheckMate_clipboard) {
     case c1_IN_beyond:
      ...
      c1_b_out = (CV_TRANSITION_EVAL(4U, (int32_T)_SFD_CCP_CALL(4U, 0,
        chartInstance->c1_sfEvent == c1_event_negabove != 0U,
        chartInstance->c1_sfEvent)) != 0);
      if (c1_b_out) {
        _SFD_CT_CALL(TRANSITION_ACTIVE_TAG, 4U, chartInstance->c1_sfEvent);
        chartInstance->c1_tp_beyond = 0U;
        _SFD_CS_CALL(STATE_INACTIVE_TAG, 0U, chartInstance->c1_sfEvent);
        chartInstance->c1_is_c1_CheckMate_clipboard = c1_IN_on;
        _SFD_CS_CALL(STATE_ACTIVE_TAG, 1U, chartInstance->c1_sfEvent);
        chartInstance->c1_tp_on = 1U;
        *c1_q = 1.0;
        _SFD_DATA_RANGE_CHECK(*c1_q, 0U);
     ...
     case c1_IN_on:
      ...
      c1_c_out = (CV_TRANSITION_EVAL(1U, (int32_T)_SFD_CCP_CALL(1U, 0,
        chartInstance->c1_sfEvent == c1_event_above != 0U,
        chartInstance->c1_sfEvent)) != 0);
      if (c1_c_out) {
        if (_SFD_TRANSITION_CONFLICT_CHECK_ENABLED()) {
          ...
          c1_d_out = (chartInstance->c1_sfEvent == c1_event_below);
          if (c1_d_out) {
        ...
        *c1_q = 3.0;
        ...
        _SFD_CT_CALL(TRANSITION_BEFORE_PROCESSING_TAG, 0U,
                     chartInstance->c1_sfEvent);
        c1_e_out = (CV_TRANSITION_EVAL(0U, (int32_T)_SFD_CCP_CALL(0U, 0,
          chartInstance->c1_sfEvent == c1_event_below != 0U,
          chartInstance->c1_sfEvent)) != 0);
        if (c1_e_out) {
          _SFD_CT_CALL(TRANSITION_ACTIVE_TAG, 0U, chartInstance->c1_sfEvent);
          chartInstance->c1_tp_on = 0U;
          _SFD_CS_CALL(STATE_INACTIVE_TAG, 1U, chartInstance->c1_sfEvent);
          chartInstance->c1_is_c1_CheckMate_clipboard = c1_IN_under;
          _SFD_CS_CALL(STATE_ACTIVE_TAG, 2U, chartInstance->c1_sfEvent);
          chartInstance->c1_tp_under = 1U;
          *c1_q = 2.0;
          _SFD_DATA_RANGE_CHECK(*c1_q, 0U);
     ...
     case c1_IN_under:
      ...
      _SFD_CT_CALL(TRANSITION_BEFORE_PROCESSING_TAG, 2U,
                   chartInstance->c1_sfEvent);
      c1_f_out = (CV_TRANSITION_EVAL(2U, (int32_T)_SFD_CCP_CALL(2U, 0,
        chartInstance->c1_sfEvent == c1_event_negbelow != 0U,
        chartInstance->c1_sfEvent)) != 0);
      if (c1_f_out) {
  ...
  *chartInstance, const mxArray *c1_b_tp_on, const char_T *c1_identifier)
{
  ...
  c1_thisId.fIdentifier = c1_identifier;
  c1_thisId.fParent = NULL;
  c1_y = c1_e_emlrt_marshallIn(chartInstance, sf_mex_dup(c1_b_tp_on), &c1_thisId);
  sf_mex_destroy(&c1_b_tp_on);
  return c1_y;
}
...
static void c1_c_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c1_mxArrayInData, const char_T *c1_varName, void *c1_outData)
{
  const mxArray *c1_b_tp_on;
  const char_T *c1_identifier;
  emlrtMsgIdentifier c1_thisId;
  uint8_T c1_y;
  SFc1_CheckMate_clipboardInstanceStruct *chartInstance;
  chartInstance = (SFc1_CheckMate_clipboardInstanceStruct *)chartInstanceVoid;
  c1_b_tp_on = sf_mex_dup(c1_mxArrayInData);
  c1_identifier = c1_varName;
  c1_thisId.fIdentifier = c1_identifier;
  c1_thisId.fParent = NULL;
  c1_y = c1_e_emlrt_marshallIn(chartInstance, sf_mex_dup(c1_b_tp_on), &c1_thisId);
...
{
  ((real_T *)mxGetPr((plhs[0])))[0] = (real_T)(458635057U);
  ((real_T *)mxGetPr((plhs[0])))[1] = (real_T)(935611560U);
  ((real_T *)mxGetPr((plhs[0])))[2] = (real_T)(2238425837U);
  ((real_T *)mxGetPr((plhs[0])))[3] = (real_T)(1050141931U);
}
...
static const mxArray *sf_get_sim_state_info_c1_CheckMate_clipboard(void)
{
  ...
  const char *infoEncStr[] = {
    "100 S1x3'type','srcId','name','auxInfo'{{M[1],M[9],T\"q\",},{M[8],M[0],T\"is_active_c1_CheckMate_clipboard\",},{M[9],M[0],T\"is_c1_CheckMate_clipboard\",}}"
  };
...
static void mdlSetWorkWidths_c1_CheckMate_clipboard(SimStruct *S)
{
  ...
  ssSetChecksum0(S,(354896142U));
  ssSetChecksum1(S,(3761845001U));
  ssSetChecksum2(S,(3949017443U));
  ssSetChecksum3(S,(3510078898U));
