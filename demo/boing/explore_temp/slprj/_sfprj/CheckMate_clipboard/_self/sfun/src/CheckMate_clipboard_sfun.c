  ...
  plhs[], int nrhs, const mxArray * prhs[] )
{
  ...
  if (nrhs>1 && mxIsChar(prhs[1])) {
    ...
    ((real_T *)mxGetPr((plhs[0])))[0] = (real_T)(3353683328U);
    ((real_T *)mxGetPr((plhs[0])))[1] = (real_T)(2132259054U);
    ((real_T *)mxGetPr((plhs[0])))[2] = (real_T)(872699503U);
    ((real_T *)mxGetPr((plhs[0])))[3] = (real_T)(3338438084U);
  }
  ...
  plhs[], int nrhs, const mxArray * prhs[] )
{
...

  {
    ...
    switch (chartFileNumber) {
     case 1:
      {
        if (strcmp(tpChksum, "xaaZxJ91uxWz5INhBiom6") == 0) {
